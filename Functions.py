...
def clip_raster_with_gdf_v1(tiff_file, gdf_poly):
    ...
    root_str = f"IMG-{str(gdf_poly.Id.iloc[0]).zfill(2)}_MPOLY-{gdf_poly.ID_POLY.iloc[0]}"
...
#     fname_img = f".{os.sep}datain{os.sep}IMG-{gdf_poly.Id.iloc[0]}_MPOLY-{gdf_poly.index[0]}_v2.tiff"
