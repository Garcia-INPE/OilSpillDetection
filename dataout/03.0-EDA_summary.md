...
## Data Source
- CSV: <project_root>/src/dataout/DS/CSV/Oil_Stats_16bits.csv
- Total rows: 385
- Total columns: 47
...
- PNG (core): combined `bar_counts.png` for CLASSE/SUBCLASSE counts, stacked bar plot for CLASSE x SUBCLASSE crosstab, numeric boxplots by class, and float-feature aggregated comparison heatmaps.
- PNG (families): feature-family boxplots by CLASSE/SUBCLASSE and `hist_family_*` histogram panels by CLASSE/SUBCLASSE.